...
import { getDashboardStats, getSiteEngineers, getPettyCash, addPettyCashTransaction } from '../../services/api';
import { MdFolder, MdAccessTime, MdWarning, MdCheckCircle, MdAccountBalanceWallet, MdArrowUpward, MdArrowDownward } from 'react-icons/md';
...
const DashboardPage = () => {
    ...
    useEffect(() => {
        Promise.all([getDashboardStats(), getSiteEngineers()])
            .then(([s, engs]) => {
                setStats(s);
                setEngineers(engs);
            })
